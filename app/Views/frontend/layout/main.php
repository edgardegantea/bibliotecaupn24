        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                ...
                <ul class="navbar-nav col-lg-6 justify-content-sm-center">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?= base_url('servicios') ?>">Sevicios</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?= base_url('reglamento') ?>">Reglamento</a>
                    </li>
                    <li class="nav-item">
...
-->
    ...
    <!--
        <nav class="navbar navbar-expand-md navbar fixed-top justify-content-md-center">
            <div class="container-fluid">
                <a class="navbar-brand" href="#">Biblioteca Digital</a>
                <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarCollapse"
                    aria-controls="navbarCollapse" aria-expanded="false" aria-label="Toggle navigation">
